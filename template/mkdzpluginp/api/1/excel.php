...
try {
    ...
    $res = $action();
    _FILENAME__env::result(array("data"=>$res),false); 
} catch (Exception $e) {
    _FILENAME__env::result(array('retcode'=>100010,'retmsg'=>$e->getMessage()),false);
}
...
{
    //1. 获取上传的文件
    $res = _FILENAME__validate::getNCParameter('excelfile','excelfile','file',0);
