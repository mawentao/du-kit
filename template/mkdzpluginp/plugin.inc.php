...
$result = array (
    ...
    'site' => array (
        ...
        'sitename'    => _FILENAME__env::get_sitename(),
        'admin_email' => _FILENAME__env::get_admin_email(),
    ), 
    '_FILENAME_' => array(
        'plugin_version' => $_G['setting']['plugins']['version']["_FILENAME_"],
        'plugin_enabled' => $plugin_enabled,
    ),
);
_FILENAME__env::result($result);
?>
