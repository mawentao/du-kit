...
<body>
  <form method="post" action="admin.php?action=plugins&operation=config&identifier=_FILENAME_&pmod=z_setting">
  <!-- 使用提示 -->
  <table class="tb tb2">
    <tr><th colspan="15" class="partition">使用提示</th></tr>
    <tr><td class="tipsblock" s="1">
      <ul id="lis">
        <li>系统地址：<a href="<%siteurl%>/plugin.php?id=_FILENAME_" target="_blank"><%siteurl%>/plugin.php?id=_FILENAME_</a></li>
      </ul>
    </td></tr>
  </table>
  <!-- 全局设置 -->
