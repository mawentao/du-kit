...
* @Date 2011/11/04 22:02:43
* @Version 1.0
* @Brief server框架实现(from pvstat-yangbaokui)
*  
\****************************************************************/
...
namespace icat
{
    ...
    **/
    ...
    public: 
         ...
         *
         * @return  int 是否出错  
         * @retval  icat::SUCC:ok icat::FAIL:出错,关闭连接
        **/
        ...
        **/
         ...
         *
         * @return  int 是否成功 icat::SUCC:成功 icat::FAIL:失败
    ...
    public:
        ...
        **/
         ...
         *
         * @return int always return icat::SUCC, 失败直接退出进程
        **/
    ...
    private:
        ...
        **/
         ...
         * @brief ub 回调函数
         *
         * @return  int icat::SUCC:成功 icat::FAIL:出错、关闭连接
        **/
