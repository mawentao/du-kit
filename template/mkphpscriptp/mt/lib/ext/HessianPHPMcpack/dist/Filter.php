...
class ProxyFilter extends InterceptingFilter{
	var $method,$params,$result, $id;
	
	function ProxyFilter($method,&$params,$id){
		$this->method = $method;
		$this->params = &$params;
        $this->id = $id;
	}
	...
	function execute(&$context,&$chain){
        $this->result = $context->executeCall($this->method,$this->params,$this->id);
		$context->callingContext['result'] = $this->result;
        $context->callingContext['id'] = $this->id;
